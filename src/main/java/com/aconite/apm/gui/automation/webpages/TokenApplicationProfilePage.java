...
public class TokenApplicationProfilePage {
    ...
    public TokenApplicationProfileDataRecord editTokenApplicationProfileData(TokenApplicationProfileDataRecord editTokenApplicationProfile, String field){
        ...
        Select selTokenImportOutputInterfaceList;
        Select selTokenOrderPinDeliveryMethodList;
        Select selTokenOrderOutputInterfaceList;
        Select selPinAdvicePinDeliveryMethodList;
        Select selPinAdviceOutputInterfaceList;
        Select selUpdatePinDeliveryMethodList;
        Select selUpdateOutputInterfaceList;
        Select selVppPinDeliveryMethodList;
        Select selVppOutputInterfaceList;
        Select selPinTemplateList;
        ...
        if(adminCommon.clickEditByUniqueId(editTokenApplicationProfile.getParentTokenProductId() + "_" + editTokenApplicationProfile.getAppSequenceNumber())) {
            ...
            switch (field) {
                ...
                case ("TokenImportOutputInterface"):
                    btnDelivery.click();
                    selTokenImportOutputInterfaceList = new Select(webDriver.findElement(By.id("input-importOutputInterface")));
                    selTokenImportOutputInterfaceList.selectByVisibleText(editTokenApplicationProfile.getTokenImportOutputInterface());
                    break;
                ...
                case ("TokenOrderOutputInterface"):
                    btnDelivery.click();
                    selTokenOrderOutputInterfaceList = new Select(webDriver.findElement(By.id("input-orderOutputInterface")));
                    selTokenOrderOutputInterfaceList.selectByVisibleText(editTokenApplicationProfile.getTokenOrderOutputInterface());
                    break;
                ...
                case ("PinAdviceOutputInterface"):
                    btnDelivery.click();
                    selPinAdviceOutputInterfaceList = new Select(webDriver.findElement(By.id("input-adviceOutputInterface")));
                    selPinAdviceOutputInterfaceList.selectByVisibleText(editTokenApplicationProfile.getPinAdviceOutputInterface());
                    break;
                ...
                case ("UpdateOutputInterface"):
                    btnDelivery.click();
                    selUpdateOutputInterfaceList = new Select(webDriver.findElement(By.id("input-updateOutputInterface")));
                    selUpdateOutputInterfaceList.selectByVisibleText(editTokenApplicationProfile.getUpdateOutputInterface());
                    break;
                ...
                case ("VppOutputInterface"):
                    btnDelivery.click();
                    selVppOutputInterfaceList = new Select(webDriver.findElement(By.id("input-vppOutputInterface")));
                    selVppOutputInterfaceList.selectByVisibleText(editTokenApplicationProfile.getVppOutputInterface());
                    break;
        ...
        if (alertDialogList.size() == 0) {
            ...
            switch (field) {
                ...
                case ("TokenImportOutputInterface"):
                    btnDelivery.click();
                    selTokenImportOutputInterfaceList = new Select(webDriver.findElement(By.id("input-importOutputInterface")));
                    if(selTokenImportOutputInterfaceList.getFirstSelectedOption().getText().equalsIgnoreCase(editTokenApplicationProfile.getTokenImportOutputInterface()))
                    {
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Token Import Output Interface: SUCCESSFUL");
                    }
                    else{
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Token Import Output Interface: UNSUCCESSFUL\n" +
                                "EXP: editTokenApplicationProfile.getTokenImportOutputInterface() = " + editTokenApplicationProfile.getTokenImportOutputInterface() + "\n" +
                                "ACT: selTokenImportOutputInterfaceList.getFirstSelectedOption().getText() = " + selTokenImportOutputInterfaceList.getFirstSelectedOption().getText());
                    }
                    break;
                ...
                case ("TokenOrderOutputInterface"):
                    btnDelivery.click();
                    selTokenOrderOutputInterfaceList = new Select(webDriver.findElement(By.id("input-orderOutputInterface")));
                    if(selTokenOrderOutputInterfaceList.getFirstSelectedOption().getText().equalsIgnoreCase(editTokenApplicationProfile.getTokenOrderOutputInterface()))
                    {
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Token Order Output Interface: SUCCESSFUL");
                    }
                    else{
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Token Order Output Interface: UNSUCCESSFUL\n" +
                                "EXP: editTokenApplicationProfile.getTokenOrderOutputInterface() = " + editTokenApplicationProfile.getTokenOrderOutputInterface() + "\n" +
                                "ACT: selTokenOrderOutputInterfaceList.getFirstSelectedOption().getText() = " + selTokenOrderOutputInterfaceList.getFirstSelectedOption().getText());
                    }
                    break;
                ...
                case ("PinAdviceOutputInterface"):
                    btnDelivery.click();
                    selPinAdviceOutputInterfaceList = new Select(webDriver.findElement(By.id("input-adviceOutputInterface")));
                    if(selPinAdviceOutputInterfaceList.getFirstSelectedOption().getText().equalsIgnoreCase(editTokenApplicationProfile.getPinAdviceOutputInterface()))
                    {
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Pin Advice Output Interface: SUCCESSFUL");
                    }
                    else{
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Pin Advice Output Interface: UNSUCCESSFUL\n" +
                                "EXP: editTokenApplicationProfile.getPinAdviceOutputInterface() = " + editTokenApplicationProfile.getPinAdviceOutputInterface() + "\n" +
                                "ACT: selPinAdviceOutputInterfaceList.getFirstSelectedOption().getText() = " + selPinAdviceOutputInterfaceList.getFirstSelectedOption().getText());
                    }
                    break;
                ...
                case ("UpdateOutputInterface"):
                    btnDelivery.click();
                    selUpdateOutputInterfaceList = new Select(webDriver.findElement(By.id("input-updateOutputInterface")));
                    if(selUpdateOutputInterfaceList.getFirstSelectedOption().getText().equalsIgnoreCase(editTokenApplicationProfile.getUpdateOutputInterface()))
                    {
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Update Output Interface: SUCCESSFUL");
                    }
                    else{
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Update Output Interface: UNSUCCESSFUL\n" +
                                "EXP: editTokenApplicationProfile.getUpdateOutputInterface() = " + editTokenApplicationProfile.getUpdateOutputInterface() + "\n" +
                                "ACT: selUpdateOutputInterfaceList.getFirstSelectedOption().getText() = " + selUpdateOutputInterfaceList.getFirstSelectedOption().getText());
                    }
                    break;
                ...
                case ("VppOutputInterface"):
                    btnDelivery.click();
                    selVppOutputInterfaceList = new Select(webDriver.findElement(By.id("input-vppPinDeliveryMethod")));
                    if(selVppOutputInterfaceList.getFirstSelectedOption().getText().equalsIgnoreCase(editTokenApplicationProfile.getVppOutputInterface()))
                    {
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Vpp Output Interface: SUCCESSFUL");
                    }
                    else{
                        editTokenApplicationProfile.setTestOutput("Edit Token Application Profile Vpp Output Interface: UNSUCCESSFUL\n" +
                                "EXP: editTokenApplicationProfile.getVppOutputInterface() = " + editTokenApplicationProfile.getVppOutputInterface() + "\n" +
                                "ACT: selVppOutputInterfaceList.getFirstSelectedOption().getText() = " + selVppOutputInterfaceList.getFirstSelectedOption().getText());
                    }
                    break;
