...
//        System.out.println("taskId = " + taskId);
    ...
    public boolean deleteTask(String taskName, String taskId){
        ...
        try {
            ...
            System.out.println("Delete Task: button exists at start: " + btnModalYesList.size());

            do{

                System.out.println("Delete Task: click button " + btnModalYesList.size());
                try {
                    btnModalYes.click();
                }
                catch(Exception e){
                ...
                System.out.println("Delete Task: check button exists after " + btnModalYesAfterList.size());
