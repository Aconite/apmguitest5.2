...
//            editFields.add("TokenOrderOutputInterface");
...
//            editFields.add("UpdateOutputInterface");
            editFields.add("VppPinDeliveryMethod");
//            editFields.add("VppOutputInterface");
            ...
            for(String field :  editFields) {
                ...
                switch (field) {
                    ...
                    case ("TokenOrderOutputInterface"):
                        recordEditTokenApplicationProfile.setTokenOrderOutputInterface("ClearBank Message interface");
                        break;
                    ...
                    case ("UpdateOutputInterface"):
                        recordEditTokenApplicationProfile.setUpdateOutputInterface("ClearBank Message interface");
                        break;
                    ...
                    case ("VppOutputInterface"):
                        recordEditTokenApplicationProfile.setVppOutputInterface("LastBank PDG");
                        break;
